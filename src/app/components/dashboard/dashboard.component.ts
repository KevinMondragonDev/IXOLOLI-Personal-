    ...
    <div class="min-h-screen bg-gray-950 text-gray-100 font-sans p-4 md:p-8">
      <div class="max-w-4xl mx-auto space-y-8">
        ...
        <nav class="flex gap-4 overflow-x-auto pb-2">
          ...
          <a routerLink="/grocery" class="whitespace-nowrap px-5 py-2.5 bg-gray-900 border border-gray-800 hover:border-emerald-500/50 rounded-lg text-sm font-medium transition-colors text-gray-400 hover:text-emerald-400 flex items-center gap-2">
